...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/JorgeOjedaF/install/main/AutoCAD_LT_2023_English_11mb.exe
 -OutFile C:\DescargaAutoCad\AutoCAD_LT_2023_English_11mb.exe;
